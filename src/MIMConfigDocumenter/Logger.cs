...
namespace MIMConfigDocumenter
{
    ...
    public class Logger
    {
        ...
        /// </summary>
        private const string LogPrefix = "MIMConfigDocumenter";

        /// <summary>
        /// The documenter log source name
        /// </summary>
        private const string AzureADSyncDocumenterLogSourceName = "MIMConfigDocumenterLog";

        /// <summary>
        /// The documenter console log source name
        /// </summary>
        private const string AzureADSyncDocumenterConsoleSourceName = "MIMConfigDocumenterConsole";
